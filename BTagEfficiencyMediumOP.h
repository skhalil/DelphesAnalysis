double EfficiencyFormulaMediumOPLight (const double pt, const double eta) { 
  return 
  ( 
   ((pt <= 20.0) * (0.000))                   + 
...
double  EfficiencyFormulaMediumOPCharm (const double pt, const double eta)         { 
  return 
               (pt <= 20.0)                                    * (0.000) + 
...
double  EfficiencyFormulaMediumOPBottom (const double pt, const double eta) { return 
               (pt <= 20.0)                                    * (0.000) + 
...
double EfficiencyFormulaMediumOP(const double flav, const double pt, const double eta) {

  if (flav <= 3 || flav == 21) return EfficiencyFormulaMediumOPLight(pt, eta);
  else if (flav == 4) return EfficiencyFormulaMediumOPCharm(pt, eta);
  else if (flav == 5) return EfficiencyFormulaMediumOPBottom(pt, eta);
  else return 0;
